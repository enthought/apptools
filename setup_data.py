...
CHACO = etsdep('Chaco', '3.3.0')  # -- only used by enthought.template
ENABLE = etsdep('Enable', '3.3.0')  # -- only used by enthought.template
...
TRAITSBACKENDWX = etsdep('TraitsBackendWX', '3.3.0')  # -- directly used only by enthought.template
TRAITSGUI = etsdep('TraitsGUI', '3.3.0')
TRAITSGUI_DOCK = etsdep('TraitsGUI[dock]', '3.3.0')  # -- only used by enthought.template
