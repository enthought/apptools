...
from traits.api import Event, Instance, Interface, List, Str, VetoableEvent

from .user_perspective_manager import UserPerspectiveManager
from .window_event import VetoableWindowEvent, WindowEvent
...
class IWorkbench(Interface):
    ...
    active_window = Instance("apptools.workbench_window.WorkbenchWindow")
    ...
    windows = List(Instance("apptools.workbench_window.WorkbenchWindow"))
